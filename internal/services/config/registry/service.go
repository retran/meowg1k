...
type Service interface {
	...
	GetDefaultProfile(providerType gateway.Provider) config.Profile
}
...
// GetDefaultProfile returns default profile settings for a provider.
func (s *serviceImpl) GetDefaultProfile(providerType gateway.Provider) config.Profile {
