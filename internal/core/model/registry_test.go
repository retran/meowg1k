...
func TestGetModelInfo(t *testing.T) {
	...
	if info.TokenizerType != model2.TokenizerCL100K {
...
func TestGetTokenizerType(t *testing.T) {
	...
	if tokenizerType != model2.TokenizerCL100K {
	...
	if tokenizerType != model2.TokenizerGemini {
	...
	if tokenizerType != model2.TokenizerLlama {
