...
func (s *Service) resolvePresetInternal( //nolint:gocognit,gocyclo,funlen // complexity inherent in multi-level preset resolution logic
	...
	resolved := &domainpreset.ResolvedPreset{
		...
		AppID:                resolvedModel.AppID,
		EditorVersion:        resolvedModel.EditorVersion,
		EditorPluginVersion:  resolvedModel.EditorPluginVersion,
		UserAgent:            resolvedModel.UserAgent,
		CopilotIntegrationID: resolvedModel.CopilotIntegrationID,
		OpenAIOrganization:   resolvedModel.OpenAIOrganization,
