...
func TestNewFactory(t *testing.T) {
	t.Run("should fail with a nil service", func(t *testing.T) {
		...
		expectedErr := "finalizesnapshots.NewFactory: indexService cannot be nil"
...
func TestActivity_Placeholder(t *testing.T) {
	t.Log("Skipping TestActivity for finalizesnapshots. Refactor index.Service to an interface to enable testing.")
}
